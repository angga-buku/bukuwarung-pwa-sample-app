package tech.arifandi.bukuwarungpwasampleclient

object Constants {
    // Root page
    var WEBAPP_URL = "https://bukuwarung-web-staging.web.app/"
    var WEBAPP_HOST = "bukuwarung-web-staging.web.app" // used for checking Intent-URLs
    ...
    var USER_AGENT_POSTFIX = "Android App" // useful for identifying traffic, e.g. in Google Analytics
